        ...
        <div className="nav-container">
          ...
          >
            ...
            <div className="nav-buttons">
              {!isLoggedIn ? (
                <>
                  <Link href="/login" className="btn-login" onClick={() => setIsMobileMenuOpen(false)}>Sign In</Link>
                  <Link href="/signup" className="btn-signup" onClick={() => setIsMobileMenuOpen(false)}>Get Started</Link>
                </>
              ) : (
                <Link href="/dashboard" className="btn-dashboard" onClick={() => setIsMobileMenuOpen(false)}>
       ...
       position: absolute;
        ...
        @media (max-width: 768px) {
          ...
          .nav-menu {
            ...
            transition: max-height 0.25s ease-in-out, opacity 0.2s ease-in-out, visibility 0.25s;
          }
